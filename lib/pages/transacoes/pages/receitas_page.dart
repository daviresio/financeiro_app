...
class ReceitasPage extends StatelessWidget {
  ...
  static String routeName = '/transacoes/receitas';

  ReceitasPage({Key key}): super(key: key);
      ...
      body: StreamBuilder<DateTime>(
        ...
        builder: (context, snapshotMesSelecionado) {
          return StreamBuilder(
              stream: _receitaDao.listReceitasComRelacionamentos(data: snapshotMesSelecionado.data),
              initialData: [],
